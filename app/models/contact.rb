class Contact < ActiveRecord::Base
	...
	#   for validations.  Check out section 6.  I might be able to do a validation if it matches at least 10 digits but not if it matches 11 digits.
	...
	# 	errors.add(:phone_num, "must be 10 digits") if :phone_num === /\d{10}/
	# end
end
